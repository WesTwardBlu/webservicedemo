 ...
 * 
 */
@WebServiceClient(name = "ServiceHelloService", targetNamespace = "http://service.com/", wsdlLocation = "http://192.168.1.104:9001/Service/ServiceHello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICEHELLOSERVICE_QNAME = new QName("http://service.com/", "ServiceHelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.1.104:9001/Service/ServiceHello?wsdl");
    ...
    public ServiceHello getServiceHelloPort() {
        return super.getPort(new QName("http://service.com/", "ServiceHelloPort"), ServiceHello.class);
    }
    ...
    public ServiceHello getServiceHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.com/", "ServiceHelloPort"), ServiceHello.class, features);
    }
